export default {
  ...
  nav: {
    ...
    ontology: 'Ontology',
    coordinateMapping: 'Coord. Mapping',
    coarseGraining: 'Coarse-Graining',
    ...
    workflowEditor: 'WF Editor',
    dataTransfer: 'Data Transfer',
    workflowScheduler: 'Scheduler',
    paramMapping: 'Param Mapping',
    workflowPresets: 'WF Presets',
  ...
  installer: {
    title: 'Solver Component Installation',
    subtitle: 'Select multiscale simulation solvers to install',
    ...
    verifySuccess: 'Verify Passed',
    verifyFailed: 'Verify Failed',
    md: { name: 'LAMMPS', desc: 'Large-scale Atomic/Molecular Massively Parallel Simulator for MD simulation' },
    dft: { name: 'Quantum ESPRESSO', desc: 'Open-source DFT code for first-principles calculations' },
    phaseField: { name: 'FiPy', desc: 'Python-based PDE solver for phase-field modeling' },
    fe: { name: 'CalculiX', desc: 'Open-source finite element solver for structural mechanics' },
  },
}